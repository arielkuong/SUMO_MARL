...
def main():
    ...
    runs = {
        ...
        "DRQN (CTDE+GNN+LSTM, seq_len=8)"             : "vdn_ctde_gnn_lstm_shared_seqlen8",
        "DRQN (CTDE+GNN+LSTM, seq_len=16)"            : "vdn_ctde_gnn_lstm_shared_seqlen16",
        "DRQN (CTDE+GNN+LSTM, seq_len=32)"            : "vdn_ctde_gnn_lstm_shared_seqlen32",
    }

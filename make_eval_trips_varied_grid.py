...
def main():
    ...
    ap.add_argument("--sim-end", type=float, default=2500.0, help="End time (s) for flows")
    ...
    ap.add_argument("--sections", type=int, default=50, help="Number of time sections per file")

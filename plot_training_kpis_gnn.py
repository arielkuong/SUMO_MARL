...
def main():
    ...
    runs = {
        ...
        "DRQN (GNN+LSTM, seq_len=8)"             : "drqn_gnn_lstm_shared_seqlen8",
        "DRQN (GNN+LSTM, seq_len=16)"            : "drqn_gnn_lstm_shared_seqlen16",
        "DRQN (GNN+LSTM, seq_len=32)"            : "drqn_gnn_lstm_shared_seqlen32",
    }

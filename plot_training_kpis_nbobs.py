...
def main():
    ...
    runs = {
        ...
        "DRQN (LSTM with nbobs, seq_len=8)"          : "drqn_lstm_shared_nbobs_seqlen8",
        "DRQN (LSTM with nbobs, seq_len=16)"         : "drqn_lstm_shared_nbobs_seqlen16",
        "DRQN (LSTM with nbobs, seq_len=32)"         : "drqn_lstm_shared_nbobs_seqlen32",
    }

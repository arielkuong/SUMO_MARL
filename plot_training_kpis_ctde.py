...
def main():
    ...
    runs = {
        ...
        "DRQN (CTDE+LSTM, seq_len=8)"             : "vdn_ctde_lstm_shared_seqlen8",
        "DRQN (CTDE+LSTM, seq_len=16)"            : "vdn_ctde_lstm_shared_seqlen16",
        "DRQN (CTDE+LSTM, seq_len=32)"            : "vdn_ctde_lstm_shared_seqlen32",
    }
